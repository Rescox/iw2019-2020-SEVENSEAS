...
public class Ship {
    ...
    public Set<Shop> getShopSet() { return shopSet; }

    public void setShopSet(Set<Shop> shopSet) { this.shopSet = shopSet; }

    public Set<Spa> getSpaSet() { return spaSet; }

    public void setSpaSet(Set<Spa> spaSet) { this.spaSet = spaSet; }
