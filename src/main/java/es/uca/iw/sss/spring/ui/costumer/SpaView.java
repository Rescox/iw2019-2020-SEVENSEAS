...
public class SpaView extends HorizontalLayout implements HasUrlParameter<Long> {
  ...
  private BeanValidationBinder<SpaReservation> binder =
      new BeanValidationBinder<>(SpaReservation.class);
  private Spa spa;
  private H3 name;
  ...
  @Autowired
  public SpaView(
      SpaReservationService spaReservationService,
      UserService userService,
      SpaRepository spaRepository,
      SpaService spaService,
      SpaReservationRepository spaReservationRepository) {
